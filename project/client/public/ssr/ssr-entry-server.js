...
const regUser = toolkit.createAsyncThunk("userData/regUser", async (data, thunkAPI) => {
  try {
...
const loginUser = toolkit.createAsyncThunk("userData/loginUser", async (data, thunkAPI) => {
  try {
...
const resendVerification = toolkit.createAsyncThunk("userData/resendVerification", async (data, thunkAPI) => {
  var _a;
  try {
...
const checkAuth = toolkit.createAsyncThunk("userData/checkAuth", async (data, thunkAPI) => {
  var _a, _b;
  try {
    const state = thunkAPI.getState();
...
const ProtectedRoute = ({ children, redirectTo }) => {
  ...
  const { isAuth, accessToken } = reactRedux.useSelector((state) => state.userData);
  ...
  return isAuth ? children : /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: redirectTo });
};
const initialState = {
  username: "",
  email: "",
...
function PageAuth({ mode }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "auth__container", children: [
    (mode === "register" || mode === "login") && /* @__PURE__ */ jsxRuntime.jsx(
      AuthForm$1,
      {
        mode,
    ...
    mode === "verified" && /* @__PURE__ */ jsxRuntime.jsx(
      UnverifiedNotice,
      {
...
const PageAuth$1 = React.memo(PageAuth);
const ErrorPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "error-page", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("h1", { children: [
      "Ошибка ",
      errorCode
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { children: decodeURIComponent(errorMessage) }),
    /* @__PURE__ */ jsxRuntime.jsx("a", { href: "/", children: "Вернуться на главную" })
  ] });
};
const MessariaPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "error-page", children: [
    /* @__PURE__ */ jsxRuntime.jsx("h1", { children: "Добро пожаловать" }),
    /* @__PURE__ */ jsxRuntime.jsx(nModules.Link, { to: "/messaria", children: "тык" })
  ] });
};
...
const routeConfig = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            element: /* @__PURE__ */ jsxRuntime.jsx(PageAuth$1, { mode: "login" })
          },
          {
            path: relativePath(CLIENT_ROUTES.auth.register, CLIENT_ROUTES.auth.base),
            element: /* @__PURE__ */ jsxRuntime.jsx(PageAuth$1, { mode: "register" })
          },
          {
            path: relativePath(CLIENT_ROUTES.auth.verified, CLIENT_ROUTES.auth.base),
            element: /* @__PURE__ */ jsxRuntime.jsx(PageAuth$1, { mode: "verified" })
          }
        ]
      },
      {
        path: relativePath(CLIENT_ROUTES.app.home),
        element: /* @__PURE__ */ jsxRuntime.jsx(MessariaPage, {}),
        private: true,
      ...
      },
      {
        ...
        element: /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: CLIENT_ROUTES.auth.login, replace: true })
      }
    ]
  }
];
function renderRoutes(routes) {
  return routes.map((route, idx) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(require$$2.Route, { path: route.path, element, children: route.children && renderRoutes(route.children) }, idx);
  });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "app__box", children: /* @__PURE__ */ jsxRuntime.jsx(PagesRouter, {}) }) });
}
