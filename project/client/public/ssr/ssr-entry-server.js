...
const regUser = toolkit.createAsyncThunk("userAuth/regUser", async (data, thunkAPI) => {
  try {
...
const loginUser = toolkit.createAsyncThunk("userAuth/loginUser", async (data, thunkAPI) => {
  try {
...
const resendVerification = toolkit.createAsyncThunk("userAuth/resendVerification", async (data, thunkAPI) => {
  var _a;
  try {
...
const checkToken = toolkit.createAsyncThunk("userAuth/checkToken", async (_, thunkAPI) => {
  try {
    const state = thunkAPI.getState();
...
const refreshToken = toolkit.createAsyncThunk("userAuth/refreshToken", async (data, thunkAPI) => {
  var _a, _b;
  try {
    const state = thunkAPI.getState();
...
const logoutUser = toolkit.createAsyncThunk("userAuth/logoutUser", async (_, thunkAPI) => {
  var _a;
  try {
    const state = thunkAPI.getState();
    const accessToken = ((_a = state.userAuth) == null ? void 0 : _a.accessToken) || "";
...
const userAuthSlice = toolkit.createSlice({
  name: "userAuth",
...
const ProtectedRoute = ({ children }) => {
  ...
  const { isAuth, accessToken, authCheckStatus } = reactRedux.useSelector((state) => state.userAuth);
  React.useEffect(() => {
    if (accessToken) {
      dispatch(checkToken());
    }
...
function AuthPage({ mode }) {
  ...
  const dispatch = reactRedux.useDispatch();
  const { tempAuthToken, errAuth, isAuth, registerStatus, loginStatus, resendActStatus } = reactRedux.useSelector((state) => state.userAuth);
...
const ErrorPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "error-page__box", role: "alert", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("script", { type: "application/ld+json", children: `{
                  "@context": "https://schema.org",
                  "@type": "ErrorPage",
                  "name": "${title}",
...
const AppNavbar = ({ isAuth, logout }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("nav", { className: "appnavbar__container", "aria-label": "Основная навигация", children: [
    /* @__PURE__ */ jsxRuntime.jsx(nModules.Link, { to: "/", className: "appnavbar__link-logo", "aria-label": "На главную", children: /* @__PURE__ */ jsxRuntime.jsx("span", { role: "img", "aria-hidden": "true", children: icon.logo }) }),
...
const AppLayout = () => {
  const dispatch = reactRedux.useDispatch();
  const { isAuth, authCheckStatus } = reactRedux.useSelector((state) => state.userAuth);
  React.useEffect(() => {
    let interval;
    let isMounted = true;
    const startInterval = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "applayout__container", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("main", { className: "applayout__main", children: /* @__PURE__ */ jsxRuntime.jsx(require$$2.Outlet, {}) })
  ] });
};
const AppLayout$1 = React.memo(AppLayout);
const NewsListPage = ({ mode }) => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: mode });
};
const NewsItemPage = ({ mode }) => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: mode });
};
const FeedPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Feed" });
};
const NewsLayout = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx(require$$2.Outlet, {}) });
};
const UserLayout = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx(require$$2.Outlet, {}) });
};
const UserSettingsPage = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "user set" });
};
const AuthLayout = () => {
    ...
    children: [
      // App
      {
        ...
        children: [
          ...
          {
            index: true,
            element: /* @__PURE__ */ jsxRuntime.jsx("span", { children: "home" })
          },
          // Auth
          {
            path: "auth",
            ...
            children: [
              ...
              {
                path: "*",
                element: /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: "/auth/sign-in", replace: true })
              }
            ]
          },
          // Feed
          ...
          {
            path: "news",
            element: /* @__PURE__ */ jsxRuntime.jsx(NewsLayout, {}),
            children: [
              // Posts - search
              {
                path: "search",
                element: /* @__PURE__ */ jsxRuntime.jsx(NewsListPage, { mode: "search" })
              },
              // Posts - favorites
              {
                path: "favorites",
                element: /* @__PURE__ */ jsxRuntime.jsx(NewsListPage, { mode: "favorites" }),
                private: true,
              ...
              {
                path: "view/:id(\\d+)",
                element: /* @__PURE__ */ jsxRuntime.jsx(NewsItemPage, { mode: "view" })
              },
              // Posts - create
              {
                path: "create",
                element: /* @__PURE__ */ jsxRuntime.jsx(NewsItemPage, { mode: "create" }),
                private: true,
                privateRedirectTo: "/auth/sign-in"
              },
              // Posts - edit
              {
                path: "edit/:id(\\d+)",
                element: /* @__PURE__ */ jsxRuntime.jsx(NewsItemPage, { mode: "edit" }),
                private: true,
                privateRedirectTo: "/auth/sign-in"
              },
              // Ошибка пути
              {
                path: "*",
                element: /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: "/news/search", replace: true })
              }
            ]
          },
          // User
          {
            ...
            children: [
              ...
              {
                path: "settings",
                element: /* @__PURE__ */ jsxRuntime.jsx(UserSettingsPage, {})
              },
              // Ошибка пути
              {
                path: "*",
                element: /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: "/user/settings", replace: true })
              }
            ]
          },
          // Error
      ...
      {
        path: "*",
        element: /* @__PURE__ */ jsxRuntime.jsx(SafeNavigate, { to: "/error", replace: true })
      }
    ]
  }
];
...
async function createApp(req, context) {
  ...
  async function loadDataForMatchedRoutes(url, store2) {
    ...
    const promisesFromRoutes = matchedRoutes.filter(({ route }) => route.ssrLoadData).map(({ route }) => store2.dispatch(route.ssrLoadData()));
    const promisesFromComponents = [];
    matchedRoutes.forEach(({ route, params }) => {
      var _a;
      const Component = (_a = route.element) == null ? void 0 : _a.type;
      if (Component && Component.fetchData) {
        promisesFromComponents.push(Component.fetchData(store2, params));
      }
    });
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(SSRContext.Provider, { value: context, children: /* @__PURE__ */ jsxRuntime.jsx(reactRedux.Provider, { store, children: /* @__PURE__ */ jsxRuntime.jsx(nModules.serverExports.StaticRouter, { location: req.originalUrl, context, children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) }) }) });
}
